...
export const Register = () => {
  ...
  return (
    <form
      ...
      className=" bg-gray-50 flex flex-col md:flex-row mx-auto p-5 md:p-10  gap-2 rounded-lg shadow-lg"
    >
      ...
      <div className="flex flex-1 flex-col justify-center items-center   ">
        ...
        <button
          onClick={() =>
            alert(
              "sorry, google integration is not handled yet , full fill form"
            )
          }
